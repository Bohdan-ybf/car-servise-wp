    ...
    <div class="test">
            ...
            <div class="container">
                <div class="service_wrapper">
                    <div class="service_box service_box_img">
                        <img class="service_img" src="<?php bloginfo('template_url'); ?>/assets/images/serv-14.jpg" alt="">
                    </div>
                    <div class="service_box">
                        <p class="service_title">Хімчистка салону авто з розбором або без</p>
        ...
        <section class="section_service section_service_even" id="restavratsiya">
            <div class="container">
                <div class="service_wrapper">
                    <div class="service_box service_box_img">
                        <img class="service_img" src="<?php bloginfo('template_url'); ?>/assets/images/serv-13.jpg" alt="">
                    </div>
                    <div class="service_box">
        ...
        <section class="section_service section_service_odd" id="tonuvannya">
            <div class="container">
                <div class="service_wrapper">
                    <div class="service_box service_box_img">
                        <img class="service_img" src="<?php bloginfo('template_url'); ?>/assets/images/serv-12.jpg" alt="">
                    </div>
                    <div class="service_box">
        ...
        <section class="section_service section_service_even" id="ozonatsiya">
            <div class="container">
                <div class="service_wrapper">
                    <div class="service_box service_box_img">
                        <img class="service_img" src="<?php bloginfo('template_url'); ?>/assets/images/serv-10.jpg" alt="">
                    </div>
                    <div class="service_box">
