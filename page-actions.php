...
<main class="main">
            ...
            <section class="section_special_offers">
                <div class="container">
                    <p class="special_offers_title special_offers_title_cust">Наша команда представляє не лише найкращий сервіс, але
                            ...
                            <button type="button" class="btn_close_offcanvas text-reset" data-bs-dismiss="modal"
                                ...
                                <svg viewBox="-0.5 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <g id="SVGRepo_iconCarrier">
                                        <path d="M3 21.32L21 3.32001" stroke="#FFFEFE" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M3 3.32001L21 21.32" stroke="#FFFEFE" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                    </g>
                                </svg>
                            </button>
